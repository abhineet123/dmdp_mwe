...
class TestModes:
    valid = range(1, 4)
    save_no_samples, save_all_samples, save_error_samples = valid
    to_str = {
        1: 'save_no_samples',
        2: 'save_all_samples',
        3: 'save_error_samples',
    }
...
def list_to_str(vals, fmt='', sep='\t'):
    ...
    return sep.join(fmt % val if fmt else fmts[type(val)] % val for val in vals  )
...
def resize_ar(src_img, width=0, height=0, return_factors=False,
              placement_type=0, only_border=0):
