...
from evaluation.devkit.Metrics import Metrics
...
class MOTMetrics(Metrics):
    def __init__(self, seqName=None):
        ...
        self.register(name="n_gt", display_name="GTO", formatter='{:.0f}'.format, write_mail=False,
                      write_db=False)  # number of ground truth detections
        self.register(name="n_tr", display_name="TRO", formatter='{:.0f}'.format, write_mail=False,
                      write_db=False)  # number of tracker detections minus ignored tracker detections
        ...
        self.register(name="n_tr_trajectories", display_name="TR", formatter='{:.0f}'.format, write_db=False,
                      write_mail=False)
